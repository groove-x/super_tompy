...
rot_x_file = open("/home/shuto/makaizou/super_tompy/animation_texts/dogma_pitch.txt", 'w')
rot_z_file = open("/home/shuto/makaizou/super_tompy/animation_texts/dogma_roll.txt", 'w')
...
def write_rotation_files():
    ...
    rot_x_file.write(
        ...
        'constexpr int dogma_pitch_len = ' +str(scene.frame_end+1)+';\n'+
        'KeyFrame dogma_pitch_frames[dogma_pitch_len] = {\n')
    rot_z_file.write(
        '#include <AnimationServo.h>\n\n'+
        'constexpr int dogma_roll_len = ' +str(scene.frame_end+1)+';\n'+
